...
export const AddCase: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white dark:bg-slate-900 relative">
      <header className="sticky top-0 z-[200] bg-white/98 dark:bg-slate-900/98 backdrop-blur-xl border-b border-slate-100 dark:border-slate-800 h-16 flex items-center shadow-sm px-2 pt-[env(safe-area-inset-top)]">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] z-[300] bg-gradient-to-t from-white via-white/90 to-transparent dark:from-slate-900 dark:via-slate-900/90 pointer-events-none">
